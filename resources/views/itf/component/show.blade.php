            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                        ...
                        <div id="logs" class="collapse">
                            ...
                            @if($weeks->verify_by_supervisor === 0)
                                <div class="alert alert-danger">
                                    <strong>This week log have not yet been verified</strong>
                                </div>
                            @endif
                    ...
                    <div style="text-align: center;">
                        <a href="{{action('ItfController@verify', ['id'=>$student->id])}}">
                            <button type="button" class="btn btn-success">
                                <i class="fa fa-btn fa-user"></i> Verify Log Book
                            </button>
                        </a>
                        <a href="{{action('ItfController@reject', ['id'=>$student->id])}}">
